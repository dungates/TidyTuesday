...
ggsave(here("Images/KenyaPopGender.png"), width = 9, height = 9)
```
...
(gg_ag_viz <- df_ag_viz %>% 
  ...
  theme(legend.position = "none",
        ...
        plot.subtitle = element_text(hjust = 0.5)))
gg_ag_viz + geom_segment(aes(y = 0, yend = 1100000, x = "Kiambu", xend = "Kiambu"),
                 arrow = grid::arrow(length = unit(0.3, "cm"),
                                                       ends = "both"), color = "gray70", size = 1.5) +
  geom_segment(aes(y = -400000, yend = 0, x = "Kiambu", xend = "Kiambu"),
                 arrow = grid::arrow(length = unit(0.3, "cm"),
                                                       ends = "both"), color = "gray70", size = 1.5)
ggsave(here("Images/HouseholdvsFarmingKenya.png"), width = 12, height = 9)
```
...
gg_ag_viz +
  ...
  annotation_custom(ggplotGrob(gg_sf), xmin = "Nakuru", xmax = "Mandera", ymin = 500000, ymax = 1100000)
```
